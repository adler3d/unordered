...
string test20131204_chat_json(IEnvRTTI&Env,TRawPtr&ptr){
...
ADDVAR(int,number,SET,0,$)\
ADDVAR(TAutoPtr<T20131202_Test>,next,DEF,$,$)\
ADDVAR(TAutoPtr<T20131202_X>,junk,DEF,$,$)\
ADDVAR(vector<T20131202_Test>,arr,DEF,$,$)\
ADDEND()
//=====+>>>>>T20131202_Test
#include "QapGenStruct.inl"
//<<<<<+=====T20131202_Test
