...
ADDBEG()\
ADDVAR(TReloadDetector,detector,DEF,$,$)\
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(TAutoPtr<ISubProgram>,Content,DEF,$,$)\
ADDEND()
//=====+>>>>>TMeUnit20130404
#include "QapGenStruct.inl"
//<<<<<+=====TMeUnit20130404
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(string,value_a,DEF,$,$)\
ADDVAR(int,value_b,SET,0,$)\
ADDEND()
...
ADDVAR(TWeakPtr<SelfClass>,Other,DEF,$,$)\
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(vector<QapNode_v001>,Items,DEF,$,$)\
ADDVAR(string,Caption,DEF,$,$)\
ADDVAR(TAutoPtr<QapItem_v001>,Content,DEF,$,$)\
ADDEND()
//=====+>>>>>QapNode_v001
#include "QapGenStruct.inl"
//<<<<<+=====QapNode_v001
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(bool,flag,SET,false,$)\
ADDVAR(TAutoPtr<ISubProgram>,SubProgram,DEF,$,$)\
ADDEND()
//=====+>>>>>TProgramFor20130406
#include "QapGenStruct.inl"
//<<<<<+=====TProgramFor20130406
