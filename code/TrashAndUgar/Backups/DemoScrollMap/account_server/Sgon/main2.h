...
ADDVAR(vector<t_msg>,messages,DEF,$,$)\
ADDVAR(vector<t_chat_node>,items,DEF,$,$)\
ADDEND()
//=====+>>>>>t_chat_node
#include "QapGenStruct.inl"
//<<<<<+=====t_chat_node
...
ADDVAR(TAutoPtr<IAppStarterImpl>,Impl,DEF,$,$)\
ADDEND()
//=====+>>>>>AppStarter
#include "QapGenStruct.inl"
//<<<<<+=====AppStarter
