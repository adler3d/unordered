  ...
  #define MACRO_WEAK_PROC(NAME,HEAD,PARAM)void NAME##HEAD{weak_##NAME<void>##PARAM;};;;template<typename TYPE>TYPE weak_##NAME##HEAD
  #define MACRO_WEAK_FUNC(TYPE,NAME,HEAD,PARAM)TYPE NAME##HEAD{return weak_##NAME<TYPE>##PARAM;};;;template<typename RETTYPE>RETTYPE weak_##NAME##HEAD
