  ...
  <body>
    <div class="b-widget-commercial b-widget-commercial_shop" data-content-block="this" style="width:0 auto; margin:0 auto;">
      <form method="POST" target="_blank" action="https://money.yandex.ru/quickpay/confirm.xml">
        ...
        <input name="referer" value="http://qap.zz.vc/14_00.html" type="hidden">
          ...
          <tbody>
            <tr>
              ...
              <td class="b-form__field">
                <div class="b-form__label">description
                </div>
                <input name="targets" value="description" type="hidden"></td>
            </tr>
            <tr>
              <td class="b-form__label">
                <label>Сумма
              ...
              <td class="b-form__field">
                <div style="width: 60px;" class="b-input-text b-input-text_inline">
                  <input class="b-input-text__input" style="text-align: right; background-color:#F0F0F0" readonly="readonly" name="sum" value="0.03" id="sum" maxlength="10" data-type="number" type="text">
                </div>
            ...
            <tr>
              ...
              <td class="b-form__field">
                <span class="b-form-radio b-form-radio_size_l b-form-radio_theme_grey i-bem b-form-radio_js_inited" onclick="return {'b-form-radio':{name:'b-form-radio',id:'id1169382976133'}}">
                  <label class="b-form-radio__button b-form-radio__button_id_ b-form-radio__button_disabled_no b-form-radio__button_side_left" for="id1169382976141" title="яырЄхц ё ърЁЄv VISA шыш MasterCard">
                  ...
                  <label class="b-form-radio__button b-form-radio__button_id_ b-form-radio__button_disabled_no b-form-radio__button_side_right b-form-radio__button_checked_yes" for="id1169382976164" title="яырЄхц шч ъю°хы№ър т -эфхъё.-хэ№урї">
                    <span class="b-form-radio__inner">
                      <span class="b-form-radio__content">
        ...
        <input name="successURL" value="redirect_addr" type="hidden">
        <input name="quickpay-back-url" value="http://qap.zz.vc/14_00.html" type="hidden">
      </form>
    </div>
