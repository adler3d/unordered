...
interface
uses
  eXgine,Tools,OpenGL,GameRender;
const
  GL_RGB8=$8051;
  GL_RGBA8=$8058;
  GL_BGR=$80E0;
...
function BallImage(Size:Integer):TATF;
function BallPathImage(Size:Integer):TATF;
...
var
  ...
  SD2,D:Real;
begin
  Result:=BallImage(Size); Result.Name:='BoolPath.ASD';
