...
inline string UIToS(const unsigned int&val){char c[16]; sprintf_s(c,sizeof(c),"%u",val); return string(c);}
...
inline unsigned int SToUI(const string&S){unsigned int i;sscanf_s(S.c_str(),"%u",&i);return i;};
