...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<TAutoPtr<i_str_item>>,arr,DEF,$,$)\
ADDEND()
//=====+>>>>>t_str_seq
#include "QapGenStruct.inl"
//<<<<<+=====t_str_seq
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,t_str_seq,first,DEF,$,$)\
ADDVAR(1,vector<t_sep_str_seq>,arr,DEF,$,$)\
ADDEND()
//=====+>>>>>t_str_code
#include "QapGenStruct.inl"
//<<<<<+=====t_str_code
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<i_char_item>,body,DEF,$,$)\
ADDEND()
//=====+>>>>>t_char
#include "QapGenStruct.inl"
//<<<<<+=====t_char
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<TAutoPtr<i_code>>,arr,DEF,$,$)\
ADDEND()
//=====+>>>>>t_code
#include "QapGenStruct.inl"
//<<<<<+=====t_code
...
ADDVAR(1,TAutoPtr<t_code>,body,DEF,$,$)\
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<i_code_with_sep>,body,DEF,$,$)\
ADDEND()
//=====+>>>>>t_value_item
#include "QapGenStruct.inl"
//<<<<<+=====t_value_item
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<i_type_templ>,body,DEF,$,$)\
ADDEND()
//=====+>>>>>t_type_templ
#include "QapGenStruct.inl"
//<<<<<+=====t_type_templ
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<t_type_scope>,scope,DEF,$,$)\
ADDVAR(1,t_name,type,DEF,$,$)\
ADDVAR(2,TAutoPtr<t_type_templ>,param,DEF,$,$)\
ADDVAR(3,vector<t_scope_type_item>,arr,DEF,$,$)\
ADDEND()
//=====+>>>>>t_type_item_type
#include "QapGenStruct.inl"
//<<<<<+=====t_type_item_type
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,t_type_scope,scope,DEF,$,$)\
ADDVAR(1,t_type_item_type,body,DEF,$,$)\
ADDEND()
//=====+>>>>>t_scope_type_item
#include "QapGenStruct.inl"
//<<<<<+=====t_scope_type_item
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<i_type_item>,body,DEF,$,$)\
ADDEND()
//=====+>>>>>t_type_templ_param
#include "QapGenStruct.inl"
//<<<<<+=====t_type_templ_param
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,t_type_templ_param,body,DEF,$,$)\
ADDEND()
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,t_type_templ_param,first,DEF,$,$)\
ADDVAR(1,vector<t_sep_type_templ_param>,arr,DEF,$,$)\
ADDEND()
//=====+>>>>>t_type_templ_params
#include "QapGenStruct.inl"
//<<<<<+=====t_type_templ_params
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<t_type_templ_params>,params,DEF,$,$)\
ADDEND()
//=====+>>>>>t_type_templ_angle
#include "QapGenStruct.inl"
//<<<<<+=====t_type_templ_angle
...
ADDVAR(4,TAutoPtr<t_value>,value,DEF,$,$)\
ADDEND()
//=====+>>>>>t_struct_field
#include "QapGenStruct.inl"
//<<<<<+=====t_struct_field
...
ADDBEG()\
ADDVAR(0,t_sep,sep,DEF,$,$)\
ADDVAR(1,t_struct_field,body,DEF,$,$)\
ADDEND()
//=====+>>>>>t_sep_struct_field
#include "QapGenStruct.inl"
//<<<<<+=====t_sep_struct_field
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<t_cmd_param>,arr,DEF,$,$)\
ADDEND()
//=====+>>>>>t_cmd_params
#include "QapGenStruct.inl"
//<<<<<+=====t_cmd_params
...
ADDVAR(1,t_name,func,DEF,$,$)\
ADDVAR(2,string,templ_params,DEF,$,$)\
ADDVAR(3,t_cmd_params,params,DEF,$,$)\
ADDEND()
//=====+>>>>>t_struct_cmd
#include "QapGenStruct.inl"
//<<<<<+=====t_struct_cmd
...
ADDBEG()\
ADDVAR(0,t_sep,sep,DEF,$,$)\
ADDVAR(1,t_struct_cmd,body,DEF,$,$)\
ADDEND()
//=====+>>>>>t_sep_struct_cmd
#include "QapGenStruct.inl"
//<<<<<+=====t_sep_struct_cmd
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<t_sep_struct_cmd>,arr,DEF,$,$)\
...
ADDBEG()\
ADDVAR(0,t_sep,sep,DEF,$,$)\
ADDVAR(1,t_struct_cmds,body,DEF,$,$)\
ADDEND()
//=====+>>>>>t_sep_struct_cmds
#include "QapGenStruct.inl"
//<<<<<+=====t_sep_struct_cmds
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<TAutoPtr<i_cpp_code>>,arr,DEF,$,$)\
ADDEND()
//=====+>>>>>t_cpp_code
#include "QapGenStruct.inl"
//<<<<<+=====t_cpp_code
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<t_target_item>,nested,DEF,$,$)\
ADDVAR(1,t_sep,sep0,DEF,$,$)\
ADDVAR(2,vector<t_sep_struct_field>,arr,DEF,$,$)\
ADDVAR(3,TAutoPtr<t_sep_struct_cmds>,cmds,DEF,$,$)\
ADDVAR(4,t_sep,sep1,DEF,$,$)\
ADDVAR(5,TAutoPtr<t_cpp_code>,cppcode,DEF,$,$)\
ADDEND()
//=====+>>>>>t_struct_body
#include "QapGenStruct.inl"
//<<<<<+=====t_struct_body
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<t_target_item>,arr,DEF,$,$)\
ADDEND()
//=====+>>>>>t_target
#include "QapGenStruct.inl"
//<<<<<+=====t_target
