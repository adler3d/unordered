...
public:
  ...
  public:
    ...
    #define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
    ADDBEG()\
    ADDVAR(0,TAutoPtr<t_minus>,minus,DEF,$,$)\
    ADDVAR(1,TAutoPtr<i_int>,val,DEF,$,$)\
    ADDVAR(2,TAutoPtr<t_frac>,frac,DEF,$,$)\
    ADDVAR(3,TAutoPtr<t_exp>,exp,DEF,$,$)\
    ADDEND()
    //=====+>>>>>t_impl
    #include "QapGenStruct.inl"
    //<<<<<+=====t_impl
  ...
  ADDVAR(1,TAutoPtr<i_value>,body,DEF,$,$)\
  ...
  #define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
  ADDBEG()\
  ADDVAR(0,vector<t_value>,arr,DEF,$,$)\
  ADDEND()
  //=====+>>>>>t_array
  #include "QapGenStruct.inl"
  //<<<<<+=====t_array
  ...
  ADDBEG()\
  ADDVAR(0,t_sep,sep0,DEF,$,$)\
  ADDVAR(1,t_string,key,DEF,$,$)\
  ADDVAR(2,t_sep,sep1,DEF,$,$)\
  ADDVAR(3,t_value,value,DEF,$,$)\
  ADDEND()
  //=====+>>>>>t_pair
  #include "QapGenStruct.inl"
  //<<<<<+=====t_pair
  ...
  #define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
  ADDBEG()\
  ADDVAR(0,vector<t_pair>,arr,DEF,$,$)\
  ADDEND()
  //=====+>>>>>t_object
  #include "QapGenStruct.inl"
  //<<<<<+=====t_object
...
public:
  ...
  #define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
  ADDBEG()\
  ADDVAR(0,string,key,DEF,$,$)\
  ADDVAR(1,TAutoPtr<i_value>,value,DEF,$,$)\
  ADDEND()
  //=====+>>>>>t_pair
  #include "QapGenStruct.inl"
  //<<<<<+=====t_pair
