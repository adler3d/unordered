...
public:
  ...
  public:
    ...
    public:
      ...
      template<>static TYPE*get<TYPE>(TYPE*p){return p;}
    public:
       void Do(t_block_expr*p){ptr=get(p);} void Do(t_bool_expr*p){ptr=get(p);} void Do(t_string_expr*p){ptr=get(p);} void Do(t_char_expr*p){ptr=get(p);} void Do(t_num_expr*p){ptr=get(p);} void Do(t_real_expr*p){ptr=get(p);} void Do(t_nullptr_expr*p){ptr=get(p);} void Do(t_or_expr*p){ptr=get(p);} void Do(t_hex_expr*p){ptr=get(p);} void Do(t_var_expr*p){ptr=get(p);}
    };
    template<class TYPE>
...
static bool go_st(i_dev&dev,TAutoPtr<SelfClass>&ref);
  ...
  class t_callconv{
  public:typedef t_inl_file OwnerClass;;
  public:typedef t_callconv SelfClass;;
  public:
   string value;; t_sep sep;;
    public:
    void DoReset();
  public:
    t_callconv(const t_callconv&)=delete;t_callconv();;
  public:
    t_callconv(t_callconv&&_Right);
    void operator=(t_callconv&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
  ...
  public:typedef t_inl_file OwnerClass;;
  public:typedef t_raw_type_expr SelfClass;;
  public:
   TAutoPtr<t_global> global;; t_sep sep;; t_scopes scopes;;
    public:
    void DoReset();
  public:
    t_raw_type_expr(const t_raw_type_expr&)=delete;t_raw_type_expr();;
  public:
    t_raw_type_expr(t_raw_type_expr&&_Right);
    void operator=(t_raw_type_expr&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
...
static bool go_st(i_dev&dev,TAutoPtr<SelfClass>&ref);
  ...
  public:
   t_sep sep_wa;; vector<t_keyword> keywords;; TAutoPtr<t_type_expr> type;; TAutoPtr<t_const_with_sep> cv;; t_sep sep0;; TAutoPtr<t_func_path> path;; TAutoPtr<t_callconv> callconv;; t_name_part name;; t_sep sep1;; TAutoPtr<i_fv_end> way;;
    public:
    void DoReset();
  public:
  ...
  class t_call_params{
  public:typedef t_inl_file OwnerClass;;
  public:typedef t_call_params SelfClass;;
  public:
   t_sep sep;; vector<t_call_param> arr;;
    public:
    void DoReset();
  public:
    t_call_params(const t_call_params&)=delete;t_call_params();;
  public:
    t_call_params(t_call_params&&_Right);
    void operator=(t_call_params&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
  ...
  public:
    class i_ext;
     class t_arr_ext; class t_call_ext; class t_tmpl_ext;
    class i_ext_visitor{
    public:
      typedef t_var_expr::i_ext i_ext;
    public:
       virtual void Do(t_arr_ext*p)=0; virtual void Do(t_call_ext*p)=0; virtual void Do(t_tmpl_ext*p)=0;
    public:
       typedef t_var_expr::t_arr_ext t_arr_ext; typedef t_var_expr::t_call_ext t_call_ext; typedef t_var_expr::t_tmpl_ext t_tmpl_ext;
    public:
      template<class TYPE,class Visitor>
      struct Is:public Visitor{
        TYPE*ptr;
      ...
      public:
        ...
        template<>static TYPE*get<TYPE>(TYPE*p){return p;}
      public:
         void Do(t_arr_ext*p){ptr=get(p);} void Do(t_call_ext*p){ptr=get(p);} void Do(t_tmpl_ext*p){ptr=get(p);}
      };
      template<class TYPE>
  ...
  public:typedef i_ext SelfClass;;
  public:
    public:
    void DoReset();
  public:
    i_ext(const i_ext&)=delete;i_ext();;
  public:
    i_ext(i_ext&&_Right);
    void operator=(i_ext&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
...
static bool go_st(i_dev&dev,TAutoPtr<SelfClass>&ref);
  ...
  public:typedef t_var_expr OwnerClass;;
  public:typedef t_arr_ext SelfClass;public:typedef i_ext ParentClass;;
  public:
   t_arr_body body;;
    public:
    void DoReset();
  public:
    t_arr_ext(const t_arr_ext&)=delete;t_arr_ext();;
  public:
    t_arr_ext(t_arr_ext&&_Right);
    void operator=(t_arr_ext&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
  ...
  public:typedef t_var_expr OwnerClass;;
  public:typedef t_call_ext SelfClass;public:typedef i_ext ParentClass;;
  public:
   TAutoPtr<t_concrete_params> concrete_params;; t_sep sep;; vector<t_call_params> arr;;
    public:
    void DoReset();
  public:
    t_call_ext(const t_call_ext&)=delete;t_call_ext();;
  public:
    t_call_ext(t_call_ext&&_Right);
    void operator=(t_call_ext&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
  ...
  public:typedef t_var_expr OwnerClass;;
  public:typedef t_tmpl_ext SelfClass;public:typedef i_ext ParentClass;;
  public:
   TAutoPtr<t_concrete_params> concrete_params;;
    public:
    void DoReset();
  public:
    t_tmpl_ext(const t_tmpl_ext&)=delete;t_tmpl_ext();;
  public:
    t_tmpl_ext(t_tmpl_ext&&_Right);
    void operator=(t_tmpl_ext&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
  ...
  public:
    ...
    class t_part{
  public:typedef t_var_expr OwnerClass;;
  public:typedef t_part SelfClass;;
  public:
   t_sep bef;; string name;; t_sep aft;; TAutoPtr<i_ext> ext;; t_sep sep;;
    public:
    void DoReset();
  public:
    t_part(const t_part&)=delete;t_part();;
  public:
    t_part(t_part&&_Right);
    void operator=(t_part&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
  ...
  public:
    ...
    class t_step{
  public:typedef t_var_expr OwnerClass;;
  public:typedef t_step SelfClass;;
  public:
   t_sep sep0;; string oper;; t_sep sep1;; t_part part;; t_sep sep2;;
    public:
    void DoReset();
  public:
    t_step(const t_step&)=delete;t_step();;
  public:
    t_step(t_step&&_Right);
    void operator=(t_step&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
  ...
  public:typedef t_impl SelfClass;;
  public:
   TAutoPtr<t_global> global;; t_sep sep0;; t_part head;; t_sep sep1;; vector<t_step> arr;;
    public:
    void DoReset();
  public:
    t_impl(const t_impl&)=delete;t_impl();;
  ...
  public:
   TAutoPtr<t_callconv> callconv;; t_sep sep0;; TAutoPtr<t_func_path> path;; string name;; t_sep sep1;; t_fv_class_stat::t_type_expr::t_func_params params;; TAutoPtr<i_func_body> body;;
    public:
    void DoReset();
  public:
  ...
  public:typedef t_impl SelfClass;;
  public:
   TAutoPtr<t_callconv> callconv;; TAutoPtr<t_explicit> prefix;; TAutoPtr<t_func_path> path;; string name;; t_sep sep;; TAutoPtr<t_concrete_params> concrete_params;; t_fv_class_stat::t_type_expr::t_func_params params;; TAutoPtr<i_func_body> body;;
    public:
    void DoReset();
  public:
    t_impl(const t_impl&)=delete;t_impl();;
  ...
  public:
    class t_impl{
  public:typedef t_oper_cast_class_stat OwnerClass;;
  public:typedef t_impl SelfClass;;
  public:
   TAutoPtr<t_callconv> callconv;; TAutoPtr<t_func_path> path;; t_sep sep0;; t_fv_class_stat::t_type_expr type;; t_sep sep1;; t_fv_class_stat::t_type_expr::t_func_params params;; TAutoPtr<t_const_with_sep> cv;; TAutoPtr<i_func_body> body;;
    public:
    void DoReset();
  public:
    t_impl(const t_impl&)=delete;t_impl();;
  ...
  public:typedef t_impl SelfClass;;
  public:
   vector<t_keyword> keywords;; t_fv_class_stat::t_type_expr type;; TAutoPtr<t_const_with_sep> cv0;; t_sep sep0;; TAutoPtr<t_callconv> callconv;; TAutoPtr<t_func_path> path;; t_sep sep1;; string oper;; t_fv_class_stat::t_type_expr::t_func_params params;; TAutoPtr<t_const_with_sep> cv1;; TAutoPtr<i_func_body> body;;
    public:
    void DoReset();
  public:
    t_impl(const t_impl&)=delete;t_impl();;
  ...
  public:
    class i_template_body;
     class t_oper_cast_template_body; class t_common_oper_template_body; class t_ctor_template_body; class t_func_template_body; class t_class_template_body;
    class i_template_body_visitor{
    public:
      typedef t_template_class_stat::i_template_body i_template_body;
    public:
       virtual void Do(t_oper_cast_template_body*p)=0; virtual void Do(t_common_oper_template_body*p)=0; virtual void Do(t_ctor_template_body*p)=0; virtual void Do(t_func_template_body*p)=0; virtual void Do(t_class_template_body*p)=0;
    public:
       typedef t_template_class_stat::t_oper_cast_template_body t_oper_cast_template_body; typedef t_template_class_stat::t_common_oper_template_body t_common_oper_template_body; typedef t_template_class_stat::t_ctor_template_body t_ctor_template_body; typedef t_template_class_stat::t_func_template_body t_func_template_body; typedef t_template_class_stat::t_class_template_body t_class_template_body;
    public:
      template<class TYPE,class Visitor>
      struct Is:public Visitor{
        TYPE*ptr;
      ...
      public:
        ...
        template<>static TYPE*get<TYPE>(TYPE*p){return p;}
      public:
         void Do(t_oper_cast_template_body*p){ptr=get(p);} void Do(t_common_oper_template_body*p){ptr=get(p);} void Do(t_ctor_template_body*p){ptr=get(p);} void Do(t_func_template_body*p){ptr=get(p);} void Do(t_class_template_body*p){ptr=get(p);}
      };
      template<class TYPE>
...
static bool go_st(i_dev&dev,TAutoPtr<SelfClass>&ref);
  ...
  public:typedef t_template_class_stat OwnerClass;;
  public:typedef t_oper_cast_template_body SelfClass;public:typedef i_template_body ParentClass;;
  public:
   t_oper_cast_class_stat::t_impl body;;
    public:
    void DoReset();
  public:
    t_oper_cast_template_body(const t_oper_cast_template_body&)=delete;t_oper_cast_template_body();;
  public:
    t_oper_cast_template_body(t_oper_cast_template_body&&_Right);
    void operator=(t_oper_cast_template_body&&_Right);
  public:
    struct ProxySys$$
    {
      typedef TTypeStruct metatype;
  ...
  public:
   vector<t_keyword> keywords;; t_fv_class_stat::t_type_expr type;; TAutoPtr<t_const_with_sep> cv0;; t_sep sep0;; TAutoPtr<t_callconv> callconv;; string func_name;; TAutoPtr<t_concrete_params> concrete_params;; t_sep sep1;; t_fv_class_stat::t_type_expr::t_func_params params;; t_sep sep2;; TAutoPtr<t_const_with_sep> cv1;; TAutoPtr<i_func_body> body;;
    public:
    void DoReset();
  public:
  ...
  public:typedef t_template_class_stat OwnerClass;;
  public:typedef t_class_template_body SelfClass;public:typedef i_template_body ParentClass;;
  public:
   string keyword;; t_sep sep0;; string name;; t_sep sep1;; TAutoPtr<t_concrete_params> params;; TAutoPtr<t_parents> parents;; t_sep sep2;; TAutoPtr<t_class_body> body;; t_sep sep3;;
    ...
    void DoReset();
  public:
    t_class_template_body(const t_class_template_body&)=delete;t_class_template_body();;
  public:
