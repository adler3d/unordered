...
ADDVAR(1,EnvVoidPtr,ptr,DEF,$,$)\
ADDVAR(2,EnvVoidPtr,ptr_lnk,DEF,$,$)\
ADDVAR(3,string,name,SET,"",$)\
ADDVAR(4,int,count,SET,0,$)\
ADDVAR(5,bool,passed,SET,false,$)\
ADDVAR(6,bool,system,SET,false,$)\
ADDVAR(7,bool,hidden,SET,false,$)\
ADDEND()
//=====+>>>>>EnvItem
...
public:
  ...
  void AddPointsFrom(const TVoidPtr::TRawPtr&ptr)
  {
     weak_detail<void>::AddPointsFrom(*this,ptr);
  }
  void UpdatePointsTypeFrom(const TVoidPtr::TRawPtr&ptr)
  {
  ...
  struct weak_detail
  {
    ...
    static void AddPointsFrom(TServerPtrSpace&Space,const TVoidPtr::TRawPtr&ptr)
    {
    ...
    static void UpdatePointsTypeFrom(TServerPtrSpace&Space,const TVoidPtr::TRawPtr&ptr)
    {
