...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,bool,AutoDisable,SET,true,$)\
ADDEND()
//=====+>>>>>TProgramNodeEx
#include "QapGenStruct.inl"
//<<<<<+=====TProgramNodeEx
...
ADDVAR(1,TAutoPtr<ISubProgram>,Body,DEF,$,$)\
ADDVAR(2,bool,Condition,SET,true,$)\
ADDEND()
//=====+>>>>>ProgramLoop
#include "QapGenStruct.inl"
//<<<<<+=====ProgramLoop
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,string,Caption,SET,"eWindow",$)\
ADDVAR(1,bool,OnTop,SET,false,$)\
ADDVAR(2,bool,FullScreen,SET,false,$)\
ADDVAR(3,bool,NeedClose,SET,false,$)\
ADDVAR(4,bool,Runned,SET,false,$)\
ADDVAR(5,bool,Visible,SET,true,$)\
ADDVAR(6,bool,Maximized,SET,false,$)\
ADDVAR(7,bool,Minimized,SET,false,$)\
ADDVAR(8,eQuad,Quad,DEF,$,$)\
ADDVAR(9,TForm,Form,SET,this,$)\
ADDVAR(10,QapKeyboard,Keyboard,DEF,$,$)\
ADDVAR(11,int,zDelta,SET,0,$)\
ADDEND()
//=====+>>>>>eWindow
#include "QapGenStruct.inl"
//<<<<<+=====eWindow
...
public:
  ...
  public:
    ...
    #define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
    ADDBEG()\
    ADDVAR(0,TWeakPtr<eWinProgram>,Win,DEF,$,$)\
    ADDEND()
    //=====+>>>>>DoClose
    #include "QapGenStruct.inl"
    //<<<<<+=====DoClose
...
public:
  ...
  public:
    ...
    ADDBEG()\
    ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
    ADDVAR(1,TWeakPtr<eWinProgram>,App,DEF,$,$)\
    ADDVAR(2,TWeakPtr<ProgramLoop>,Loop,DEF,$,$)\
    ADDEND()
    //=====+>>>>>ExitCondition
    #include "QapGenStruct.inl"
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TWeakPtr<AppStarter>,Starter,DEF,$,$)\
ADDEND()
//=====+>>>>>eBuildDefProgram
#include "QapGenStruct.inl"
//<<<<<+=====eBuildDefProgram
...
ADDVAR(2,bool,AutoLoad,SET,true,$)\
ADDVAR(4,bool,AutoSave,SET,true,$)\
ADDVAR(8,TAutoPtr<QapProgram>,Root,DEF,$,$)\
ADDEND()
//=====+>>>>>eAppStarter_v01
#include "QapGenStruct.inl"
//<<<<<+=====eAppStarter_v01
