...
namespace{
  ...
  #define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
  ADDBEG()\
  ADDVAR(0,TAutoPtr<QapItem>,Item,DEF,$,$)\
...
ADDVAR(1,string,x,DEF,$,$)\
ADDVAR(2,string,y,DEF,$,$)\
ADDEND()
//=====+>>>>>TTargetForPtr
#include "QapGenStruct.inl"
//<<<<<+=====TTargetForPtr
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<IUniPtrHolder>,Holder,DEF,$,$)\
ADDVAR(1,string,str_type_fn,DEF,$,$)\
ADDVAR(2,string,str_type_raw,DEF,$,$)\
ADDEND()
//=====+>>>>>T20130406_Debuger
#include "QapGenStruct.inl"
//<<<<<+=====T20130406_Debuger
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TWeakPtr<TYPE>,Value,DEF,$,$)\
ADDEND()
//=====+>>>>>TUnitPtr
#include "QapGenStruct.inl"
//<<<<<+=====TUnitPtr
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TWeakPtr<TTargetForPtr>,Value,DEF,$,$)\
ADDEND()
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TWeakPtr<ISubProgram>,Value,DEF,$,$)\
ADDEND()
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,T20130406_Debuger,debugger,DEF,$,$)\
ADDEND()
//=====+>>>>>T20130406_New2
#include "QapGenStruct.inl"
//<<<<<+=====T20130406_New2
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,string,filename,SET,"mega_file",$)\
ADDVAR(1,bool,need_save,SET,false,$)\
ADDVAR(2,bool,need_load,SET,false,$)\
ADDVAR(3,bool,enabled,SET,false,$)\
ADDVAR(4,int,mode,SET,0,$)\
ADDVAR(5,string,mode_as_string,DEF,$,$)\
ADDVAR(6,TAutoPtr<ISubProgram>,root,DEF,$,$)\
ADDEND()
//=====+>>>>>TProgramPlainHolder
#include "QapGenStruct.inl"
//<<<<<+=====TProgramPlainHolder
