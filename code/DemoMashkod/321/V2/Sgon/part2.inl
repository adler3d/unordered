...
ADDVAR(1,THardPtr<IEnvRTTI>,Env,DEF,$,$)\
ADDVAR(2,THardPtr<IFactory>,Factory,DEF,$,$)\
ADDVAR(3,TTypeInfo,Info,DEF,$,$)\
ADDEND()
//=====+>>>>>TType
#include "QapGenStruct.inl"
//<<<<<+=====TType
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,THardPtr<IBinIO>,BinIO,DEF,$,$)\
ADDVAR(1,THardPtr<ITxtIO>,TxtIO,DEF,$,$)\
ADDEND()
//=====+>>>>>TTypeSys
#include "QapGenStruct.inl"
//<<<<<+=====TTypeSys
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,THardPtr<TType>,SizeType,DEF,$,$)\
ADDVAR(1,THardPtr<TType>,ElementType,DEF,$,$)\
ADDVAR(2,THardPtr<IVectorAPI>,VecAPI,DEF,$,$)\
ADDEND()
//=====+>>>>>TTypeVector
#include "QapGenStruct.inl"
//<<<<<+=====TTypeVector
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,THardPtr<TType>,ElementType,DEF,$,$)\
ADDVAR(1,THardPtr<TType>,SubType,DEF,$,$)\
ADDVAR(2,THardPtr<TType>,SmartType,DEF,$,$)\
ADDEND()
//=====+>>>>>TTypeFactory
#include "QapGenStruct.inl"
//<<<<<+=====TTypeFactory
...
ADDBEG()\
ADDVAR(0,string,Name,SET,"unnamed",$)\
ADDVAR(1,THardPtr<TType>,Type,DEF,$,$)\
ADDEND()
//=====+>>>>>QapSysMember
#include "QapGenStruct.inl"
//<<<<<+=====QapSysMember
...
ADDBEG()\
ADDVAR(0,THardPtr<TType>,ElementType,DEF,$,$)\
ADDVAR(1,QapSysMember,mSaveID,DEF,$,$)\
ADDEND()
//=====+>>>>>TTypeSelfPtr
#include "QapGenStruct.inl"
//<<<<<+=====TTypeSelfPtr
...
ADDBEG()\
ADDVAR(0,THardPtr<TType>,ElementType,DEF,$,$)\
ADDVAR(1,QapSysMember,mType,DEF,$,$)\
ADDEND()
//=====+>>>>>TTypeAutoPtr
#include "QapGenStruct.inl"
//<<<<<+=====TTypeAutoPtr
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,QapSysMember,mType,DEF,$,$)\
ADDVAR(1,QapSysMember,mPtr,DEF,$,$)\
ADDEND()
//=====+>>>>>TTypeVoidPtr
#include "QapGenStruct.inl"
//<<<<<+=====TTypeVoidPtr
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,QapSysMember,mObject,DEF,$,$)\
ADDVAR(1,QapSysMember,mType,DEF,$,$)\
ADDVAR(2,QapSysMember,mOffset,DEF,$,$)\
ADDVAR(3,QapSysMember,mIndex,DEF,$,$)\
ADDEND()
//=====+>>>>>TTypeFieldPtr
#include "QapGenStruct.inl"
//<<<<<+=====TTypeFieldPtr
...
public:
  ...
  public:
    ...
    ADDVAR(2,int,Offset,SET,0,$)\
    ADDVAR(4,THardPtr<TType>,Type,DEF,$,$)\
  ...
  public:
    ...
    #define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
    ADDBEG()\
    ADDVAR(0,int,SelfId,SET,-1,$)\
    ADDVAR(1,string,SpecInfo,DEF,$,$)\
    ADDVAR(2,bool,Polymorph,SET,false,$)\
    ADDVAR(3,bool,Abstract,SET,false,$)\
    ADDVAR(4,bool,PoorDesign,SET,false,$)\
    ADDEND()
    //=====+>>>>>TExtInfo
    #include "QapGenStruct.inl"
    //<<<<<+=====TExtInfo
...
public:
  ...
  void AddMemberSET(int Number,TType*MemType,const string&MemName,int Offset,const string&Mode,const string&Value)
  {
  ...
  void AddMemberDEF(int Number,TType*MemType,const string&MemName,int Offset,const string&Mode,const string&Value)
  {
    Member tmp;
    tmp.Number=Number;
    tmp.Type=MemType;
