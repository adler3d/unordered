...
ADDBEG()\
ADDVAR(0,TWeakPtr<QapFontObject>,FontObject,DEF,$,$)\
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,TGUIRect,Current,SET,TGUIRect(vec2d(0,0),vec2d(256,128)),$)\
ADDVAR(2,TGUIRect,Rect,SET,TGUIRect(vec2d(0,0),vec2d(256,128)),$)\
ADDVAR(3,TGUIRect,Anchors,SET,TGUIRect(vec2d(0,0),vec2d(0,0)),$);\
ADDVAR(4,TWeakPtr<IGUI_Content>,Content,DEF,$,$);\
ADDVAR(5,vector<TGUI_Panel>,Items,DEF,$,$)\
ADDEND()
//=====+>>>>>TGUI_Panel
#include "QapGenStruct.inl"
//<<<<<+=====TGUI_Panel
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,string,Caption,SET,"GUI_Panel_Builder",$)\
ADDEND()
//=====+>>>>>MeUnit20121009
#include "QapGenStruct.inl"
//<<<<<+=====MeUnit20121009
