...
public:
  ...
  typedef TYPE ptr_t;
private:
  void operator=(const TSelfPtr<TYPE>&Ref){QapAssert(0);} //This class can not be copied
  TSelfPtr(const TSelfPtr<TYPE>&Ref){QapAssert(0);}       //This class can not be copied
private:
