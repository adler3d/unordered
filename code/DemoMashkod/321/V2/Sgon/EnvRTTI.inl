...
ADDBEG()\
ADDVAR(0,TWeakPtr<TType>,type,DEF,$,$)\
ADDVAR(1,int,mode,SET,mmRet,$)\
ADDEND()
//=====+>>>>>TEnvRTTI
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,string,FullName,DEF,$,$)\
ADDVAR(1,TProduct,Type,DEF,$,$)\
ADDVAR(2,TProduct,Factory,DEF,$,$)\
ADDEND()
//=====+>>>>>EnvTypeHolder
#include "QapGenStruct.inl"
//<<<<<+=====EnvTypeHolder
...
ADDVAR(2,UniqueID,ID,DEF,$,$)\
ADDVAR(3,vector<TMessage>,messages,DEF,$,$)\
ADDVAR(4,THardPtr<IEnvRTTI>,OwnerEnv,DEF,$,$)\
ADDEND()
//=====+>>>>>TEnvRTTI
#include "QapGenStruct.inl"
//<<<<<+=====TEnvRTTI
