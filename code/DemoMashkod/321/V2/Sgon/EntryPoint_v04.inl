...
public:
  ...
  public:
    ...
    #define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
    ADDBEG()\
    ADDVAR(0,string,Caption,DEF,$,$)\
    ADDVAR(1,vector<TAutoPtr<Item>>,Items,DEF,$,$)\
    ADDEND()
    //=====+>>>>>Node
    #include "QapGenStruct.inl"
    //<<<<<+=====Node
  ...
  public:
    ...
    ADDVAR(1,TWeakPtr<Item>,Friend,DEF,$,$)\
    ADDEND()
    //=====+>>>>>Leaf
    #include "QapGenStruct.inl"
    //<<<<<+=====Leaf
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,int,FirstField,SET,0,$)\
ADDVAR(1,TWeakPtr<DeclareType>,pDeclareType,DEF,$,$)\
ADDVAR(2,TDependsStruct,Sub,DEF,$,$)\
ADDVAR(4,TOtherDependsStruct,Sup,DEF,$,$)\
ADDVAR(5,vector<TWeakPtr<Item>>,ArrOfWeakPtr,DEF,$,$)\
ADDVAR(6,TBadStruct::Node,Root,DEF,$,$)\
ADDEND()
//=====+>>>>>TBadStruct
#include "QapGenStruct.inl"
//<<<<<+=====TBadStruct
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,TFieldPtr,Field,DEF,$,$)\
ADDVAR(2,TBadStruct::Node,Tree,DEF,$,$)\
ADDEND()
//=====+>>>>>TBadLeaf
#include "QapGenStruct.inl"
//<<<<<+=====TBadLeaf
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<TAutoPtr<TCaptionStruct>>,Captions,DEF,$,$)\
ADDVAR(1,vector<TWeakPtr<TCaptionStruct>>,PtrArray,DEF,$,$)\
ADDEND()
//=====+>>>>>TSomeContainer
#include "QapGenStruct.inl"
//<<<<<+=====TSomeContainer
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TWeakPtr<TMegaHolder>,Owner,DEF,$,$)\
ADDEND()
//=====+>>>>>IMegaItem
#include "QapGenStruct.inl"
//<<<<<+=====IMegaItem
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,TAutoPtr<IMegaItem>,Item,DEF,$,$)\
ADDEND()
//=====+>>>>>TMegaHolder
#include "QapGenStruct.inl"
//<<<<<+=====TMegaHolder
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,vector<TMegaHolder>,Items,DEF,$,$)\
ADDEND()
//=====+>>>>>TMegaContainer
#include "QapGenStruct.inl"
//<<<<<+=====TMegaContainer
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,DeclareTypeStruct,FieldType,DEF,$,$)\
ADDVAR(2,DeclareTypeSelfPtr,SelfType,DEF,$,$)\
