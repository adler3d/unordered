...
//`Сценарий 1a: Используеться для автоматизации работы с полями сущности
  ...
  //==Declaration Members==//
  public:
    #define DEF_PRO_ADDVAR(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)TYPE NAME;;
  ...
  //`Сценарий 1c: используеться для инициализации классса
    ...
    void DoReset()
    {
      ...
      #define DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)(this->NAME)=(VALUE);
      #define DEF_PRO_ADDVAR(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_MODE_##MODE(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_DEF(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)detail::FieldTryDoReset(this->NAME);
      #define DEF_PRO_MODE_SET(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SYS(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SYD(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)detail::FieldTryDoReset(this->NAME);
      //`#define DEF_PRO_MODE_MOV(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_MODE_SET(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #include "QapDefProVar.inl"
      #undef DEF_PRO_MODE_
  ...
  public:
    #define DEF_PRO_CONSTRUCTOR(NAME)NAME(const NAME&){QapDebugMsg(DEF_PRO_TOTEXT2(NAME)" is noncopyable");DoReset();};NAME(){DoReset();};
  ...
  public:
    ...
    (
      ...
      #define DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)TYPE&&NAME,
      #define DEF_PRO_ADDVAR(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_MODE_##MODE(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_DEF(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SET(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SYS(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)static_assert(0,"bad field - \""DEF_PRO_TOTEXT2(NAME)"\". DEF_PRO_AUTO_CONSTRUCTOR() defined");
      #define DEF_PRO_MODE_SYD(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)static_assert(0,"bad field - \""DEF_PRO_TOTEXT2(NAME)"\". DEF_PRO_AUTO_CONSTRUCTOR() defined");
      #define DEF_PRO_MODE_(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_MODE_SET(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #include "QapDefProVar.inl"
      #undef DEF_PRO_MODE_
      #undef DEF_PRO_MODE_SYD
    ...
    #undef DEF_PRO_USE
    {
      #define DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)this->NAME=std::move(NAME);;
      #define DEF_PRO_ADDVAR(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_MODE_##MODE(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_DEF(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SET(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SYS(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)static_assert(0,"bad field - \""DEF_PRO_TOTEXT2(NAME)"\". DEF_PRO_AUTO_CONSTRUCTOR() defined");
  ...
  public:
    ...
    #undef DEF_PRO_COPY
    {
      ...
      #define DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)this->NAME=_Right.NAME;;
      #define DEF_PRO_ADDVAR(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_MODE_##MODE(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_DEF(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SET(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SYS(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)static_assert(0,"bad field - \""DEF_PRO_TOTEXT2(NAME)"\". DEF_PRO_AUTO_COPY() defined");
      #define DEF_PRO_MODE_SYD(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)static_assert(0,"bad field - \""DEF_PRO_TOTEXT2(NAME)"\". DEF_PRO_AUTO_COPY() defined");
      #include "QapDefProVar.inl"
      #undef DEF_PRO_ADDVAR
      #undef DEF_PRO_MODE_SYD
      #undef DEF_PRO_MODE_SYS
  ...
  public:
    ...
    #undef DEF_PRO_MOVE
    {
      ...
      #define DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)this->NAME=std::move(_Right.NAME);;
      #define DEF_PRO_ADDVAR(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_MODE_##MODE(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_DEF(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SET(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
      #define DEF_PRO_MODE_SYS(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)static_assert(0,"bad field - \""DEF_PRO_TOTEXT2(DEF_CLASS_NAME())"::"DEF_PRO_TOTEXT2(NAME)"\". DEF_PRO_MANUAL_MOVE() not defined");
      #define DEF_PRO_MODE_SYD(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)static_assert(0,"bad field - \""DEF_PRO_TOTEXT2(DEF_CLASS_NAME())"::"DEF_PRO_TOTEXT2(NAME)"\". DEF_PRO_MANUAL_MOVE() not defined");
      #include "QapDefProVar.inl"
      #undef DEF_PRO_ADDVAR
      #undef DEF_PRO_MODE_SYD
      #undef DEF_PRO_MODE_SYS
  ...
  public:
    struct ProxySys$$
    {
      ...
      {
        string Name=DEF_PRO_STRUCT_INFO(DEF_PRO_TOTEXT2,DEF_PRO_MACRO_BLANK,DEF_PRO_MACRO_BLANK);;;
        ...
        #define DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)Info->AddMember##MODE(NUMBER,Sys$$<TYPE>::GetRTTI(RTTI),DEF_PRO_TOTEXT2(NAME),OFFSET_OF(NAME),#MODE,#VALUE);;
        #define DEF_PRO_ADDVAR(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_MODE_##MODE(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
        #define DEF_PRO_MODE_DEF(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
        #define DEF_PRO_MODE_SET(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)DEF_PRO_USE_IT(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)
        #define DEF_PRO_MODE_SYS(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)Info->AddMember##MODE(0,nullptr,DEF_PRO_TOTEXT2(NAME),OFFSET_OF(NAME),#MODE);;
        #define DEF_PRO_MODE_SYD(NUMBER,TYPE,NAME,MODE,VALUE,RESERVED)Info->AddMember##MODE(0,nullptr,DEF_PRO_TOTEXT2(NAME),OFFSET_OF(NAME),#MODE);;
        #include "QapDefProVar.inl"
        #undef DEF_PRO_ADDVAR
        #undef DEF_PRO_MODE_SYD
        #undef DEF_PRO_MODE_SYS
