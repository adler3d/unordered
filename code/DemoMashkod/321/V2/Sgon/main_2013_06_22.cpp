...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<TAutoPtr<IStatement>>,arr,DEF,$,$)\
ADDEND()\
//=====+>>>>>BlockStatement
#include "QapGenStruct.inl"
//<<<<<+=====BlockStatement
...
ADDVAR(1,TAutoPtr<IExpression>,init,DEF,$,$)\
ADDEND()\
//=====+>>>>>VariableDeclarator
#include "QapGenStruct.inl"
//<<<<<+=====VariableDeclarator
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<TAutoPtr<IStatement>>,nodes,DEF,$,$)\
ADDEND()\
//=====+>>>>>t_program
#include "QapGenStruct.inl"
//<<<<<+=====t_program
...
ADDBEG()\
ADDVAR(0,string,id,DEF,$,$)\
ADDVAR(1,vector<string>,params,DEF,$,$)\
ADDVAR(2,BlockStatement,body,DEF,$,$)\
ADDEND()\
//=====+>>>>>FunctionDeclaration
#include "QapGenStruct.inl"
//<<<<<+=====FunctionDeclaration
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<IExpression>,expression,DEF,$,$)\
ADDEND()\
//=====+>>>>>ExpressionStatement
#include "QapGenStruct.inl"
//<<<<<+=====ExpressionStatement
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,vector<VariableDeclarator>,declarations,DEF,$,$)\
ADDEND()\
//=====+>>>>>VariableStatement
#include "QapGenStruct.inl"
//<<<<<+=====VariableStatement
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<IExpression>,callee,DEF,$,$)\
ADDVAR(1,vector<TAutoPtr<IExpression>>,arguments,DEF,$,$)\
ADDEND()\
//=====+>>>>>CallExpression
#include "QapGenStruct.inl"
//<<<<<+=====CallExpression
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<IExpression>,test,DEF,$,$)\
ADDVAR(1,TAutoPtr<IStatement>,consequent,DEF,$,$)\
ADDVAR(2,TAutoPtr<IStatement>,alternate,DEF,$,$)\
ADDEND()\
//=====+>>>>>IfStatement
#include "QapGenStruct.inl"
//<<<<<+=====IfStatement
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TAutoPtr<IExpression>,init,DEF,$,$)\
ADDVAR(1,TAutoPtr<IExpression>,test,DEF,$,$)\
ADDVAR(2,TAutoPtr<IExpression>,update,DEF,$,$)\
ADDVAR(3,TAutoPtr<IStatement>,body,DEF,$,$)\
ADDEND()\
//=====+>>>>>ForStatement
#include "QapGenStruct.inl"
//<<<<<+=====ForStatement
...
ADDVAR(1,TAutoPtr<IExpression>,left,DEF,$,$)\
ADDVAR(2,TAutoPtr<IExpression>,right,DEF,$,$)\
ADDEND()\
//=====+>>>>>BinaryExpression
#include "QapGenStruct.inl"
//<<<<<+=====BinaryExpression
...
ADDBEG()\
ADDVAR(0,string,oper,DEF,$,$)\
ADDVAR(1,bool,prefix,DEF,$,$)\
ADDVAR(2,string,argument,DEF,$,$)\
ADDEND()\
//=====+>>>>>UpdateExpression
#include "QapGenStruct.inl"
//<<<<<+=====UpdateExpression
