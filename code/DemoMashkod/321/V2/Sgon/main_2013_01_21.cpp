...
public:
  ...
  public:
    ...
    ADDVAR(1,int,x,SET,0,$)\
    ADDVAR(2,int,y,SET,0,$)\
    ADDVAR(3,int,w,SET,0,$)\
    ADDVAR(4,int,h,SET,0,$)\
    ADDVAR(5,TWeakPtr<QapAtlas>,Atlas,DEF,$,$)\
    ADDVAR(6,TAutoPtr<IFrameSource>,Source,DEF,$,$)\
    ADDEND()
    //=====+>>>>>TFrame
    #include "QapGenStruct.inl"
    //<<<<<+=====TFrame
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,int,W,SET,512,$)\
ADDVAR(2,int,H,SET,512,$)\
ADDVAR(3,int,X,SET,0,$)\
ADDVAR(4,int,Y,SET,0,$)\
ADDVAR(5,int,Ident,SET,2,$)\
ADDVAR(6,int,DebugIdent,SET,1,$)\
ADDVAR(7,int,dY,SET,0,$)\
ADDVAR(8,QapTexMem,Mem,DEF,$,$)\
ADDVAR(9,QapTex,Tex,DEF,$,$)\
ADDVAR(10,vector<TFrame>,Frames,DEF,$,$)\
ADDEND()
//=====+>>>>>QapAtlas
#include "QapGenStruct.inl"
//<<<<<+=====QapAtlas
...
ADDVAR(2,real,r,SET,8,$)\
ADDVAR(3,real,hp,SET,1.0,$)\
ADDVAR(4,real,power,SET,0.15,$)\
ADDVAR(5,bool,isuser,SET,false,$)\
ADDVAR(6,bool,deaded,SET,false,$)\
ADDVAR(7,int,bonus_bullets,SET,0,$)\
ADDVAR(8,TWeakPtr<QapAtlas::TFrame>,frame,DEF,$,$)\
ADDVAR(9,TWeakPtr<QapAtlas::TFrame>,frame_s,DEF,$,$)\
ADDEND()
//=====+>>>>>TBot
#include "QapGenStruct.inl"
//<<<<<+=====TBot
...
ADDVAR(0,vec2d,p,SET,vec2d(0,0),$)\
ADDVAR(1,vec2d,v,SET,vec2d(0,0),$)\
ADDVAR(2,real,r,SET,2,$)\
ADDVAR(3,real,damage,SET,1.0,$)\
ADDVAR(4,bool,deaded,SET,false,$)\
ADDEND()
//=====+>>>>>TBullet
#include "QapGenStruct.inl"
//<<<<<+=====TBullet
...
ADDBEG()\
ADDVAR(0,vec2d,p,SET,vec2d(0,0),$)\
ADDVAR(2,real,r,SET,24,$)\
ADDVAR(3,int,tick,SET,0,$)\
ADDVAR(4,int,maxtick,SET,64,$)\
ADDVAR(5,int,GenCount,SET,0,$)\
ADDEND()
//=====+>>>>>TRespawn
#include "QapGenStruct.inl"
//<<<<<+=====TRespawn
...
ADDVAR(0,vec2d,p,SET,vec2d(0,0),$)\
ADDVAR(1,vec2d,v,SET,vec2d(0,0),$)\
ADDVAR(2,real,r,SET,16,$)\
ADDVAR(3,real,ang,SET,0,$)\
ADDVAR(4,bool,deaded,SET,false,$)\
ADDVAR(5,TWeakPtr<IAction>,action,DEF,$,$)\
ADDVAR(6,TWeakPtr<QapAtlas::TFrame>,frame,DEF,$,$)\
ADDVAR(7,TWeakPtr<QapAtlas::TFrame>,frame_s,DEF,$,$)\
ADDEND()
//=====+>>>>>TBonus
#include "QapGenStruct.inl"
//<<<<<+=====TBonus
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,QapAtlas,Atlas,DEF,$,$)\
ADDVAR(2,QapTexGen,Gen,DEF,$,$)\
ADDEND()
//=====+>>>>>QapAtlasObject
#include "QapGenStruct.inl"
//<<<<<+=====QapAtlasObject
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,TWeakPtr<TGameHC2013>,Game,DEF,$,$)\
ADDVAR(2,QapAtlas,Atlas,DEF,$,$)\
ADDVAR(3,QapFontObject,Norm,DEF,$,$)\
ADDVAR(4,QapFontObject,Blur,DEF,$,$)\
ADDEND()
//=====+>>>>>QapGameObject
#include "QapGenStruct.inl"
//<<<<<+=====QapGameObject 
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,TWeakPtr<QapAtlas>,Atlas,DEF,$,$)\
ADDVAR(2,TWeakPtr<QapFontObject>,NormFontObject,DEF,$,$)\
ADDVAR(3,TWeakPtr<QapFontObject>,BlurFontObject,DEF,$,$)\
ADDVAR(4,vec2d,mapsize,SET,vec2d(768,768),$)\
ADDVAR(5,vec2d,winpos,SET,vec2d(0,0),$)\
ADDVAR(6,TBot,You,DEF,$,$)\
ADDVAR(7,bool,Winned,SET,false,$)\
ADDVAR(8,int,BotLeft,SET,0,$)\
ADDVAR(9,int,Shots,SET,0,$)\
ADDVAR(10,int,Frags,SET,0,$)\
ADDVAR(11,int,TickCount,SET,0,$)\
ADDVAR(20,int,ForceAdded,SET,0,$)\
ADDVAR(21,int,BonusAdded,SET,0,$)\
ADDVAR(40,bool,Stage2,SET,false,$)\
ADDVAR(41,bool,ShowInfo,SET,true,$)\
ADDVAR(50,vector<TBot>,Bots,DEF,$,$)\
ADDVAR(51,vector<TBot>,dBots,DEF,$,$)\
ADDVAR(52,vector<TRespawn>,Respawns,DEF,$,$)\
ADDVAR(53,vector<TBullet>,Bullets,DEF,$,$)\
ADDVAR(54,vector<TBonus>,Bonuses,DEF,$,$)\
ADDVAR(101,TWeakPtr<TFrame>,FrameWin,DEF,$,$)\
ADDVAR(102,TWeakPtr<TFrame>,FrameYou,DEF,$,$)\
ADDVAR(103,TWeakPtr<TFrame>,FrameBotA,DEF,$,$)\
ADDVAR(104,TWeakPtr<TFrame>,FrameBotB,DEF,$,$)\
ADDVAR(105,TWeakPtr<TFrame>,FrameBotC,DEF,$,$)\
ADDVAR(106,TWeakPtr<TFrame>,FramedBotA,DEF,$,$)\
ADDVAR(107,TWeakPtr<TFrame>,FramedBotB,DEF,$,$)\
ADDVAR(108,TWeakPtr<TFrame>,FramedBotC,DEF,$,$)\
ADDVAR(109,TWeakPtr<TFrame>,FrameDeadBot,DEF,$,$)\
ADDVAR(110,TWeakPtr<TFrame>,FrameRespawn,DEF,$,$)\
ADDVAR(111,TWeakPtr<TFrame>,FrameBullet,DEF,$,$)\
ADDVAR(112,TWeakPtr<TFrame>,FrameBonus,DEF,$,$)\
ADDVAR(113,TWeakPtr<TFrame>,FrameHealth,DEF,$,$)\
ADDVAR(114,TWeakPtr<TFrame>,FrameBonus_s,DEF,$,$)\
ADDVAR(115,TWeakPtr<TFrame>,FrameHealth_s,DEF,$,$)\
ADDVAR(116,TWeakPtr<TFrame>,FrameAtlas,DEF,$,$)\
ADDVAR(117,TWeakPtr<TFrame>,FrameBotA_s,DEF,$,$)\
ADDVAR(118,TWeakPtr<TFrame>,FrameYou_s,DEF,$,$)\
ADDVAR(200,TWeakPtr<QapKeyboard>,Keyboard,DEF,$,$)\
ADDVAR(201,TWeakPtr<MeUnitHC2013>,TheUnit,DEF,$,$)\
ADDVAR(300,BonusAction_AddBullet,ActionAddBullet,DEF,$,$)\
ADDVAR(301,BonusAction_AddHP,ActionAddHP,DEF,$,$)\
ADDEND()
//=====+>>>>>TGameHC2013
#include "QapGenStruct.inl"
//<<<<<+=====TGameHC2013
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TWeakPtr<TGameHC2013>,Game,DEF,$,$)\
ADDVAR(1,int,GameSpeed,SET,1,$)\
ADDVAR(2,bool,Enabled,SET,true,$)\
ADDVAR(3,bool,Visible,SET,true,$)\
ADDEND()
//=====+>>>>>TGameHC2013Friend
#include "QapGenStruct.inl"
//<<<<<+=====TGameHC2013Friend
...
ADDBEG()\
ADDVAR(0,TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(1,int,value,SET,0,$)\
ADDVAR(2,string,str_value,DEF,$,$)\
ADDVAR(3,bool,auto_inc,SET,true,$)\
ADDVAR(4,bool,auto_itos,SET,true,$)\
ADDVAR(5,TWeakPtr<QapRenderProgram>,RenderProgram,DEF,$,$)\
ADDVAR(6,TWeakPtr<IProgramD3D9>,ProgramD3D9,DEF,$,$)\
ADDVAR(7,TWeakPtr<TProgramNode>,UserCode,DEF,$,$)\
ADDVAR(8,TWeakPtr<QapKeyboard>,Keyboard,DEF,$,$)\
ADDVAR(9,TGameHC2013,Game,DEF,$,$)\
ADDVAR(10,bool,need_init_game,SET,false,$)\
ADDEND()
//=====+>>>>>MeUnitHC2013
#include "QapGenStruct.inl"
//<<<<<+=====MeUnitHC2013
