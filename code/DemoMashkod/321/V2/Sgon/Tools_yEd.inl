...
public:
  ...
  public:
    ...
    ADDBEG()\
    ADDVAR(0,string,filename,SET,"template.graphml",$)\
    ADDVAR(1,string,content,DEF,$,$)\
    ADDEND()
    //=====+>>>>>TContent
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,TContent,output,SET,TContent(string("tree.graphml"),string("")),$)\
ADDVAR(1,TContent,graph_templ,SET,TContent(string("HQ/template.graphml"),string("")),$)\
ADDVAR(2,TContent,node_templ,SET,TContent(string("HQ/node.tml"),string("")),$)\
ADDVAR(3,TContent,edge_templ,SET,TContent(string("HQ/edge.tml"),string("")),$)\
ADDVAR(4,TContent,group_templ,SET,TContent(string("HQ/group.tml"),string("")),$)\
ADDVAR(5,vector<TNode>,nodes,DEF,$,$)\
ADDVAR(6,vector<vec2i>,edges,DEF,$,$)\
ADDEND()
//=====+>>>>>ToolsYED
#include "QapGenStruct.inl"
//<<<<<+=====ToolsYED
