...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,string,FullName,SET,"unnamed",$)\
ADDEND()
//=====+>>>>>DeclareTypeSys
#include "QapGenStruct.inl"
//<<<<<+=====DeclareTypeSys
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,int,Number,SET,-1,$)\
ADDVAR(1,string,Name,SET,"unnamed",$)\
ADDVAR(4,TWeakPtr<DeclareType>,Type,DEF,$,$)\
ADDVAR(5,string,Mode,DEF,$,$)\
ADDVAR(6,string,Value,DEF,$,$)\
ADDEND()
//=====+>>>>>DeclareMember
#include "QapGenStruct.inl"
//<<<<<+=====DeclareMember
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(0,string,Name,SET,"unnamed",$)\
ADDVAR(1,TWeakPtr<DeclareType>,SubType,DEF,$,$)\
ADDVAR(2,TWeakPtr<DeclareType>,OwnType,DEF,$,$)\
ADDVAR(3,vector<DeclareMember>,Members,DEF,$,$)\
ADDEND()
//=====+>>>>>DeclareTypeStruct
#include "QapGenStruct.inl"
//<<<<<+=====DeclareTypeStruct
...
public:
  ...
  void AddMember(int Number,DeclareType*MemType,const string&MemName,const string&Mode,const string&Value)
  {
    DeclareMember tmp;
    tmp.Number=Number;
    tmp.Type=MemType;
...
public:
  ...
  public:
    ...
    bool Result;
    DeclareType*pValue;
    IsEqualTo(TSPACE&Space):Space(Space),Result(false),pValue(nullptr){}
  public:
    struct EqualDetail
    {
      static bool Equal(TSPACE&Space,...){return false;}
      static bool Equal(TSPACE&Space,DeclareTypeSys*pA,DeclareTypeSys*pB)
      {
        return pA->FullName==pB->FullName;
      }
      static bool Equal(TSPACE&Space,DeclareTypeSelfPtr*pA,DeclareTypeSelfPtr*pB)
      {
        return IsEqualFuncEx(Space,pA->ElementType.get(),pB->ElementType.get());
        return false;
      }
      static bool Equal(TSPACE&Space,DeclareTypeAutoPtr*pA,DeclareTypeAutoPtr*pB)
      {
        return IsEqualFuncEx(Space,pA->ElementType.get(),pB->ElementType.get());
        return false;
      }
      static bool Equal(TSPACE&Space,DeclareTypeWeakPtr*pA,DeclareTypeWeakPtr*pB)
      {
        return IsEqualFuncEx(Space,pA->ElementType.get(),pB->ElementType.get());
        return false;
      }
      static bool Equal(TSPACE&Space,DeclareTypeHardPtr*pA,DeclareTypeHardPtr*pB)
      {
        return IsEqualFuncEx(Space,pA->ElementType.get(),pB->ElementType.get());
        return false;
      }
      static bool Equal(TSPACE&Space,DeclareTypeVoidPtr*pA,DeclareTypeVoidPtr*pB)
      {
        //QapDebugMsg("no way");
        return true;
      }
      static bool Equal(TSPACE&Space,DeclareTypeFieldPtr*pA,DeclareTypeFieldPtr*pB)
      {
        //QapDebugMsg("no way");
        return true;
      }
      static bool Equal(TSPACE&Space,DeclareTypeVector*pA,DeclareTypeVector*pB)
      {
        return IsEqualFuncEx(Space,pA->ElementType.get(),pB->ElementType.get());
        return false;
      }
      static bool Equal(TSPACE&Space,DeclareTypeArray*pA,DeclareTypeArray*pB)
      {
        if(pA->Size!=pB->Size)return false;
        return IsEqualFuncEx(Space,pA->ElementType.get(),pB->ElementType.get());
        return false;
      }
      static bool Equal(TSPACE&Space,DeclareTypeStruct*pA,DeclareTypeStruct*pB)
      {
    ...
    public:
      ...
      TYPE*pInput;
      bool Result;
      IsEqual(TSPACE&Space):Space(Space),Result(false),pInput(nullptr){}
    public:
      void Do(DeclareTypeSys*p)
      {
        Result=EqualDetail::Equal(Space,p,pInput);
      }
      void Do(DeclareTypeSelfPtr*p)
      {
        Result=EqualDetail::Equal(Space,p,pInput);
    ...
    template<class TYPE>
    static bool IsEqualFunc(TSPACE&Space,TYPE*pInput,DeclareType*pValue)
    {
    ...
    void Do(DeclareTypeSys*p)
    {
      Result=IsEqualFunc(Space,p,pValue);
    }
    void Do(DeclareTypeSelfPtr*p)
    {
      Result=IsEqualFunc(Space,p,pValue);
