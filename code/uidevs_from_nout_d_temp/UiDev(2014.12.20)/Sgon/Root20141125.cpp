#define ThisCompileUnit ThisCompileUnit$t_components
#define ThisCompileUnitInstance ThisCompileUnitInstance$t_components
#include "t_components.cpp"
#undef ThisCompileUnitInstance
#undef ThisCompileUnit
#define ThisCompileUnit ThisCompileUnit$branch_lex_v3
#define ThisCompileUnitInstance ThisCompileUnitInstance$branch_lex_v3
#include "branch_lex_v3.cpp"
#undef ThisCompileUnitInstance
#undef ThisCompileUnit
...
#undef ThisCompileUnit
/*
#define ThisCompileUnit ThisCompileUnit$drag_rects
#define ThisCompileUnitInstance ThisCompileUnitInstance$drag_rects
#include "drag_rects.cpp"
#undef ThisCompileUnitInstance
#undef ThisCompileUnit*/
#define ThisCompileUnit ThisCompileUnit$dungeon_server
#define ThisCompileUnitInstance ThisCompileUnitInstance$dungeon_server
#include "dungeon_server.cpp"
#undef ThisCompileUnitInstance
#undef ThisCompileUnit
/*
#define ThisCompileUnit ThisCompileUnit$GameAndEasyScript
#define ThisCompileUnitInstance ThisCompileUnitInstance$GameAndEasyScript
#include "GameAndEasyScript.cpp"
#undef ThisCompileUnitInstance
#undef ThisCompileUnit
*/
...
#undef ThisCompileUnit
/*
#define ThisCompileUnit ThisCompileUnit$simple_rect_test
#define ThisCompileUnitInstance ThisCompileUnitInstance$simple_rect_test
#include "simple_rect_test.cpp"
#undef ThisCompileUnitInstance
#undef ThisCompileUnit
*/
