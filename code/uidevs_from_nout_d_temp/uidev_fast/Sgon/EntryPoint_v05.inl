...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(TWeakPtr<TType>,Value,DEF,$,$)\
ADDVAR(int,price,SET,99,$)\
ADDVAR(DeclareEnvRTTI,DeclareEnv,DEF,$,$)\
ADDVAR(TAutoPtr<TMineStruct>,next,DEF,$,$)\
ADDEND()
//=====+>>>>>TMineStruct
#include "QapGenStruct.inl"
//<<<<<+=====TMineStruct
...
ADDVAR(TAutoPtr<SelfClass>,Sub,DEF,$,$)\
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(string,Caption,SET,"crumb",$)\
ADDVAR(TWeakPtr<TType>,pType,DEF,$,$)\
ADDVAR(TAutoPtr<TType>,Value,DEF,$,$)\
ADDEND()
...
ADDBEG()\
ADDVAR(string,Caption,SET,"crumb",$)\
ADDVAR(TWeakPtr<DeclareType>,pType,DEF,$,$)\
ADDVAR(TAutoPtr<DeclareType>,Value,DEF,$,$)\
ADDEND()
...
ADDBEG()\
ADDVAR(string,Caption,SET,"crumb",$)\
ADDVAR(TWeakPtr<DeclareTypeWeakPtr>,pTypeA,DEF,$,$)\
ADDEND()
...
ADDBEG()\
ADDVAR(TSelfPtr<SelfClass>,Self,DEF,$,$)\
ADDVAR(TWeakPtr<DeclareType>,Link,DEF,$,$)\
ADDEND()
//=====+>>>>>EnvDefTypePtr
#include "QapGenStruct.inl"
//<<<<<+=====EnvDefTypePtr
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(EnvDefTypeStr,Str,DEF,$,$)\
ADDVAR(EnvDefTypePtr,Ptr,DEF,$,$)\
ADDVAR(EnvType,Type,DEF,$,$)\
ADDVAR(DeclareEnvRTTI,DeclEnv,DEF,$,$)\
ADDVAR(TWeakPtr<DeclareTypeWeakPtr>,Troll,DEF,$,$)\
ADDVAR(TWeakPtr<TType>,TrollPtr,DEF,$,$)\
ADDEND()
...
#define DEF_PRO_VARIABLE(ADDBEG,ADDVAR,ADDEND)\
ADDBEG()\
ADDVAR(string,Str,SET,"egg",$)\
ADDVAR(int,RunCount,SET,0,$)\
ADDVAR(double,LoadTime,SET,0,$)\
ADDEND()
