...
t_inl_file::t_fv_class_stat::t_type_expr::t_arr_body::t_arr_body(){DoReset();}
t_inl_file::t_fv_class_stat::t_type_expr::t_arr_body::t_arr_body(t_arr_body&&_Right){operator=(std::move(_Right));}
...
t_inl_file::t_fv_class_stat::t_type_expr::t_arr_body::ProxySys$$::metatype*t_inl_file::t_fv_class_stat::t_type_expr::t_arr_body::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
      {
...
void t_inl_file::t_fv_class_stat::t_type_expr::t_fv_stat::DoReset()
   ...
   detail::FieldTryDoReset(this->sep_wa); detail::FieldTryDoReset(this->keywords); detail::FieldTryDoReset(this->type); detail::FieldTryDoReset(this->cv); detail::FieldTryDoReset(this->sep0); detail::FieldTryDoReset(this->path); detail::FieldTryDoReset(this->name); detail::FieldTryDoReset(this->sep1); detail::FieldTryDoReset(this->way);
    }
...
void t_inl_file::t_fv_class_stat::t_type_expr::t_fv_stat::operator=(t_fv_stat&&_Right)
   ...
   this->sep_wa=std::move(_Right.sep_wa);; this->keywords=std::move(_Right.keywords);; this->type=std::move(_Right.type);; this->cv=std::move(_Right.cv);; this->sep0=std::move(_Right.sep0);; this->path=std::move(_Right.path);; this->name=std::move(_Right.name);; this->sep1=std::move(_Right.sep1);; this->way=std::move(_Right.way);;
    }
...
t_inl_file::t_call_expr::t_call_expr(){DoReset();}
t_inl_file::t_call_expr::t_call_expr(t_call_expr&&_Right){operator=(std::move(_Right));}
...
t_inl_file::t_call_expr::ProxySys$$::metatype*t_inl_file::t_call_expr::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
      {
   ...
   Info->AddMemberDEF(Sys$$<string>::GetRTTI(RTTI),"func",int(&(((SelfClass*)nullptr)->*(&SelfClass::func))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_sep>::GetRTTI(RTTI),"sep",int(&(((SelfClass*)nullptr)->*(&SelfClass::sep))),"DEF","$");; Info->AddMemberDEF(Sys$$<vector<t_call_param>>::GetRTTI(RTTI),"arr",int(&(((SelfClass*)nullptr)->*(&SelfClass::arr))),"DEF","$");;
        {
          RTTI.OnRegEnd(Info);
        }
        {
...
void t_inl_file::t_call_expr::Use(i_visitor&A){A.Do(this);}
t_inl_file::t_call_expr::SelfClass*t_inl_file::t_call_expr::UberCast(ParentClass*ptr){return i_visitor::UberCast<SelfClass>(ptr);}
...
t_inl_file::t_var_expr::t_item::t_item(){DoReset();}
t_inl_file::t_var_expr::t_item::t_item(t_item&&_Right){operator=(std::move(_Right));}
...
t_inl_file::t_var_expr::t_item::ProxySys$$::metatype*t_inl_file::t_var_expr::t_item::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
      {
        static const string Name="t_item";;;
        TTypeStruct*Info=nullptr;
        if(RTTI.Register<SelfClass>(Info,Name)){
   ...
   Info->AddMemberDEF(Sys$$<t_type_with_sep>::GetRTTI(RTTI),"body",int(&(((SelfClass*)nullptr)->*(&SelfClass::body))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_sep>::GetRTTI(RTTI),"sep",int(&(((SelfClass*)nullptr)->*(&SelfClass::sep))),"DEF","$");;
        {
          RTTI.OnRegEnd(Info);
        }
        {
...
void t_inl_file::t_var_expr::t_field::DoReset()
   ...
   detail::FieldTryDoReset(this->bef); detail::FieldTryDoReset(this->name); detail::FieldTryDoReset(this->aft);
    }
t_inl_file::t_var_expr::t_field::t_field(){DoReset();}
t_inl_file::t_var_expr::t_field::t_field(t_field&&_Right){operator=(std::move(_Right));}
void t_inl_file::t_var_expr::t_field::operator=(t_field&&_Right)
   ...
   this->bef=std::move(_Right.bef);; this->name=std::move(_Right.name);; this->aft=std::move(_Right.aft);;
    }
t_inl_file::t_var_expr::t_field::ProxySys$$::metatype*t_inl_file::t_var_expr::t_field::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
      {
   ...
   Info->AddMemberDEF(Sys$$<t_sep>::GetRTTI(RTTI),"bef",int(&(((SelfClass*)nullptr)->*(&SelfClass::bef))),"DEF","$");; Info->AddMemberDEF(Sys$$<string>::GetRTTI(RTTI),"name",int(&(((SelfClass*)nullptr)->*(&SelfClass::name))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_sep>::GetRTTI(RTTI),"aft",int(&(((SelfClass*)nullptr)->*(&SelfClass::aft))),"DEF","$");;
        {
          RTTI.OnRegEnd(Info);
        }
        {
...
void t_inl_file::t_var_expr::t_impl::DoReset()
   ...
   detail::FieldTryDoReset(this->items); detail::FieldTryDoReset(this->sep); detail::FieldTryDoReset(this->arr);
    }
...
void t_inl_file::t_var_expr::t_impl::operator=(t_impl&&_Right)
   ...
   this->items=std::move(_Right.items);; this->sep=std::move(_Right.sep);; this->arr=std::move(_Right.arr);;
    }
t_inl_file::t_var_expr::t_impl::ProxySys$$::metatype*t_inl_file::t_var_expr::t_impl::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
   ...
   Info->AddMemberDEF(Sys$$<vector<t_item>>::GetRTTI(RTTI),"items",int(&(((SelfClass*)nullptr)->*(&SelfClass::items))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_sep>::GetRTTI(RTTI),"sep",int(&(((SelfClass*)nullptr)->*(&SelfClass::sep))),"DEF","$");; Info->AddMemberDEF(Sys$$<vector<t_field>>::GetRTTI(RTTI),"arr",int(&(((SelfClass*)nullptr)->*(&SelfClass::arr))),"DEF","$");;
        {
          RTTI.OnRegEnd(Info);
        }
        {
...
t_inl_file::t_var_expr::ProxySys$$::metatype*t_inl_file::t_var_expr::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
   ...
   Info->AddMemberDEF(Sys$$<string>::GetRTTI(RTTI),"name",int(&(((SelfClass*)nullptr)->*(&SelfClass::name))),"DEF","$");;
        ...
        {
            Info->AddNested(Sys$$<t_item>::GetRTTI(RTTI));; Info->AddNested(Sys$$<t_field>::GetRTTI(RTTI));; Info->AddNested(Sys$$<t_impl>::GetRTTI(RTTI));;;
        }
        Info->SelfTesting();
        return Info;
      }
...
void t_inl_file::t_dtor_class_stat::DoReset()
   ...
   detail::FieldTryDoReset(this->sep0); detail::FieldTryDoReset(this->path); detail::FieldTryDoReset(this->name); detail::FieldTryDoReset(this->sep1); detail::FieldTryDoReset(this->params); detail::FieldTryDoReset(this->body);
    }
...
void t_inl_file::t_dtor_class_stat::operator=(t_dtor_class_stat&&_Right)
   ...
   this->sep0=std::move(_Right.sep0);; this->path=std::move(_Right.path);; this->name=std::move(_Right.name);; this->sep1=std::move(_Right.sep1);; this->params=std::move(_Right.params);; this->body=std::move(_Right.body);;
    }
...
void t_inl_file::t_ctor_class_stat::t_impl::DoReset()
   ...
   detail::FieldTryDoReset(this->prefix); detail::FieldTryDoReset(this->path); detail::FieldTryDoReset(this->name); detail::FieldTryDoReset(this->sep1); detail::FieldTryDoReset(this->concrete_params); detail::FieldTryDoReset(this->params); detail::FieldTryDoReset(this->body);
    }
...
void t_inl_file::t_ctor_class_stat::t_impl::operator=(t_impl&&_Right)
   ...
   this->prefix=std::move(_Right.prefix);; this->path=std::move(_Right.path);; this->name=std::move(_Right.name);; this->sep1=std::move(_Right.sep1);; this->concrete_params=std::move(_Right.concrete_params);; this->params=std::move(_Right.params);; this->body=std::move(_Right.body);;
    }
t_inl_file::t_ctor_class_stat::t_impl::ProxySys$$::metatype*t_inl_file::t_ctor_class_stat::t_impl::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
   ...
   Info->AddMemberDEF(Sys$$<TAutoPtr<t_explicit>>::GetRTTI(RTTI),"prefix",int(&(((SelfClass*)nullptr)->*(&SelfClass::prefix))),"DEF","$");; Info->AddMemberDEF(Sys$$<TAutoPtr<t_func_path>>::GetRTTI(RTTI),"path",int(&(((SelfClass*)nullptr)->*(&SelfClass::path))),"DEF","$");; Info->AddMemberDEF(Sys$$<string>::GetRTTI(RTTI),"name",int(&(((SelfClass*)nullptr)->*(&SelfClass::name))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_sep>::GetRTTI(RTTI),"sep1",int(&(((SelfClass*)nullptr)->*(&SelfClass::sep1))),"DEF","$");; Info->AddMemberDEF(Sys$$<TAutoPtr<t_concrete_params>>::GetRTTI(RTTI),"concrete_params",int(&(((SelfClass*)nullptr)->*(&SelfClass::concrete_params))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_fv_class_stat::t_type_expr::t_func_params>::GetRTTI(RTTI),"params",int(&(((SelfClass*)nullptr)->*(&SelfClass::params))),"DEF","$");; Info->AddMemberDEF(Sys$$<TAutoPtr<i_func_body>>::GetRTTI(RTTI),"body",int(&(((SelfClass*)nullptr)->*(&SelfClass::body))),"DEF","$");;
        {
          RTTI.OnRegEnd(Info);
        }
        {
...
void t_inl_file::t_oper_cast_class_stat::DoReset()
   ...
   detail::FieldTryDoReset(this->path); detail::FieldTryDoReset(this->sep0); detail::FieldTryDoReset(this->type); detail::FieldTryDoReset(this->sep1); detail::FieldTryDoReset(this->params); detail::FieldTryDoReset(this->cv); detail::FieldTryDoReset(this->body);
    }
...
void t_inl_file::t_oper_cast_class_stat::operator=(t_oper_cast_class_stat&&_Right)
   ...
   this->path=std::move(_Right.path);; this->sep0=std::move(_Right.sep0);; this->type=std::move(_Right.type);; this->sep1=std::move(_Right.sep1);; this->params=std::move(_Right.params);; this->cv=std::move(_Right.cv);; this->body=std::move(_Right.body);;
    }
t_inl_file::t_oper_cast_class_stat::ProxySys$$::metatype*t_inl_file::t_oper_cast_class_stat::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
   ...
   Info->AddMemberDEF(Sys$$<TAutoPtr<t_func_path>>::GetRTTI(RTTI),"path",int(&(((SelfClass*)nullptr)->*(&SelfClass::path))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_sep>::GetRTTI(RTTI),"sep0",int(&(((SelfClass*)nullptr)->*(&SelfClass::sep0))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_fv_class_stat::t_type_expr>::GetRTTI(RTTI),"type",int(&(((SelfClass*)nullptr)->*(&SelfClass::type))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_sep>::GetRTTI(RTTI),"sep1",int(&(((SelfClass*)nullptr)->*(&SelfClass::sep1))),"DEF","$");; Info->AddMemberDEF(Sys$$<t_fv_class_stat::t_type_expr::t_func_params>::GetRTTI(RTTI),"params",int(&(((SelfClass*)nullptr)->*(&SelfClass::params))),"DEF","$");; Info->AddMemberDEF(Sys$$<TAutoPtr<t_const_with_sep>>::GetRTTI(RTTI),"cv",int(&(((SelfClass*)nullptr)->*(&SelfClass::cv))),"DEF","$");; Info->AddMemberDEF(Sys$$<TAutoPtr<i_func_body>>::GetRTTI(RTTI),"body",int(&(((SelfClass*)nullptr)->*(&SelfClass::body))),"DEF","$");;
        {
          RTTI.OnRegEnd(Info);
        }
        {
...
void t_inl_file::t_common_oper_class_stat::t_impl::DoReset()
   ...
   detail::FieldTryDoReset(this->keywords); detail::FieldTryDoReset(this->type); detail::FieldTryDoReset(this->cv0); detail::FieldTryDoReset(this->sep0); detail::FieldTryDoReset(this->path); detail::FieldTryDoReset(this->sep1); detail::FieldTryDoReset(this->oper); detail::FieldTryDoReset(this->params); detail::FieldTryDoReset(this->cv1); detail::FieldTryDoReset(this->body);
    }
...
void t_inl_file::t_common_oper_class_stat::t_impl::operator=(t_impl&&_Right)
   ...
   this->keywords=std::move(_Right.keywords);; this->type=std::move(_Right.type);; this->cv0=std::move(_Right.cv0);; this->sep0=std::move(_Right.sep0);; this->path=std::move(_Right.path);; this->sep1=std::move(_Right.sep1);; this->oper=std::move(_Right.oper);; this->params=std::move(_Right.params);; this->cv1=std::move(_Right.cv1);; this->body=std::move(_Right.body);;
    }
...
void t_inl_file::t_template_class_stat::t_func_template_body::DoReset()
   ...
   detail::FieldTryDoReset(this->keywords); detail::FieldTryDoReset(this->type); detail::FieldTryDoReset(this->cv0); detail::FieldTryDoReset(this->sep0); detail::FieldTryDoReset(this->func_name); detail::FieldTryDoReset(this->concrete_params); detail::FieldTryDoReset(this->sep1); detail::FieldTryDoReset(this->params); detail::FieldTryDoReset(this->sep2); detail::FieldTryDoReset(this->cv1); detail::FieldTryDoReset(this->body);
    }
...
void t_inl_file::t_template_class_stat::t_func_template_body::operator=(t_func_template_body&&_Right)
   ...
   this->keywords=std::move(_Right.keywords);; this->type=std::move(_Right.type);; this->cv0=std::move(_Right.cv0);; this->sep0=std::move(_Right.sep0);; this->func_name=std::move(_Right.func_name);; this->concrete_params=std::move(_Right.concrete_params);; this->sep1=std::move(_Right.sep1);; this->params=std::move(_Right.params);; this->sep2=std::move(_Right.sep2);; this->cv1=std::move(_Right.cv1);; this->body=std::move(_Right.body);;
    }
...
void t_inl_file::t_template_class_stat::class_template_body::DoReset()
    {
      {
        detail::TryDoReset<SelfClass>(this);;
      }
...
t_inl_file::t_template_class_stat::class_template_body::class_template_body(){DoReset();}
t_inl_file::t_template_class_stat::class_template_body::class_template_body(class_template_body&&_Right){operator=(std::move(_Right));}
void t_inl_file::t_template_class_stat::class_template_body::operator=(class_template_body&&_Right)
    {
      struct hidden{static void foo(i_template_body(*)=(SelfClass*)nullptr){}};;;;
      if(&_Right==this)return;
      {
...
t_inl_file::t_template_class_stat::class_template_body::ProxySys$$::metatype*t_inl_file::t_template_class_stat::class_template_body::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
      {
...
string t_inl_file::t_template_class_stat::class_template_body::ProxySys$$::GetFullName()
      {
        return "class_template_body";;;
      }
void t_inl_file::t_template_class_stat::class_template_body::Use(i_visitor&A){A.Do(this);}
t_inl_file::t_template_class_stat::class_template_body::SelfClass*t_inl_file::t_template_class_stat::class_template_body::UberCast(ParentClass*ptr){return i_visitor::UberCast<SelfClass>(ptr);}
bool t_inl_file::t_template_class_stat::class_template_body::go(i_dev&dev){
        t_fallback scope(dev,__FUNCTION__);
        auto&ok=scope.ok;
        auto&D=scope.mandatory;
        auto&M=scope.mandatory;
...
t_inl_file::t_template_class_stat::ProxySys$$::metatype*t_inl_file::t_template_class_stat::ProxySys$$::GetRTTI(IEnvRTTI&RTTI)
   ...
   Info->AddMemberDEF(Sys$$<t_head>::GetRTTI(RTTI),"head",int(&(((SelfClass*)nullptr)->*(&SelfClass::head))),"DEF","$");; Info->AddMemberDEF(Sys$$<TAutoPtr<i_template_body>>::GetRTTI(RTTI),"body",int(&(((SelfClass*)nullptr)->*(&SelfClass::body))),"DEF","$");;
        ...
        {
            Info->AddNested(Sys$$<t_template_param>::GetRTTI(RTTI));; Info->AddNested(Sys$$<t_common_oper_template_body>::GetRTTI(RTTI));; Info->AddNested(Sys$$<t_ctor_template_body>::GetRTTI(RTTI));; Info->AddNested(Sys$$<t_func_template_body>::GetRTTI(RTTI));; Info->AddNested(Sys$$<class_template_body>::GetRTTI(RTTI));; Info->AddNested(Sys$$<t_name_template_param>::GetRTTI(RTTI));; Info->AddNested(Sys$$<t_head>::GetRTTI(RTTI));; Info->AddNested(Sys$$<t_type_template_param>::GetRTTI(RTTI));;;
        }
        Info->SelfTesting();
        return Info;
      }
