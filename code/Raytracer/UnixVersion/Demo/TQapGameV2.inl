...
ADD(HWND&,hWnd,win.Form.WinPair.hWnd)\
ADD(int&,zDelta,win.zDelta)\
//===
#include "defprovar.inl"
//===
public:
  TQapGameV2():viewport(qDev.viewport),consize(viewport.size),hWnd(win.Form.WinPair.hWnd),zDelta(win.zDelta){DoReset();}
public:
  ...
  void DrawDownedKeys()
  {
    ...
    qDev.SetColor(0xff7a7a7a);
    qDev.DrawSolidCircle(mpos,5,8,0);
  }
public:
